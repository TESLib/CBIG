# CBIG_LBC_longComBat_FC_wrapper.R
...
# File paths
source(file.path(repo_root, "util", "stats", "long_combat", "CBIG_LBC_longCombat_FC.R"))
input_csv_path <- file.path(LBC_rep_dir, "Data", "FC_Y0Y2.csv")
output_csv_path <- file.path(LBC_rep_dir, "Data", "FC_Y0Y2_combat.csv")

# Run function
CBIG_LBC_longCombat_FC(input_csv_path, output_csv_path)
